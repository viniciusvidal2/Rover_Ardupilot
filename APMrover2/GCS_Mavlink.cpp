...
//    ahrs.get_position(pos);
    ...
    mavlink_msg_global_position_int_send(
        ...
        ac_media_x*10000.0f, //int(100*(vel2.x))*10000.0f, // vel.x * 100,   // X speed cm/s (+ve North)
        ac_media_y*10000.0f, // vel.y * 100,   // Y speed cm/s (+ve East)
        ac_media_z*10000.0f, // vel.z * -100,  // Z speed cm/s (+ve up)
        ahrs.yaw_sensor);
}
